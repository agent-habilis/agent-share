 ...
 * browser's selection. The pages under `agent-share-app` render inside its outlet
...
import { publishAgentSession } from 'agent-share-core/agentTools'
import { describe } from 'agent-share-core/agentTools/result'
...
import {
  ...
  type Progress,
  type SaveTarget,
} from 'agent-share-core/download'
import {
  disposeMount,
  emptySyncedState,
  pickMountRoot,
  ...
  type MountSession,
  type SyncedState,
} from 'agent-share-core/mount'
import { parseRoute, parseTransport, type TransportMode } from 'agent-share-core/ticket'
import type { TransferSnapshot } from 'agent-share-core/transferStats'
import {
  buildTree,
  filesUnder,
  nodeAtPath,
