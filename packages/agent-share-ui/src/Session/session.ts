 ...
 *
 * The pages under `agent-share-app` are mounted by the router's `Outlet`, which
...
import type { Client } from 'agent-share-core/client'
import type { Progress } from 'agent-share-core/download'
