...
impl WebRtcTransport {
    ...
    /// (no IP, no relay) — for tests and single-purpose peers like the
    /// browser demo. agent-gossip itself calls
    /// `Builder::add_custom_transport` directly so `WebRTC` stays additive.
